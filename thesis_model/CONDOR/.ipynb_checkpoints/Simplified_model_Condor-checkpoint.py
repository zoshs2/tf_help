...
Color = '10h' # or observational time : {10h, 100h}, otherwise, 'RGB' denotes '1000h' for observational times.
Noise = 'WG' # WG_{hours}h: WHITE_GAUSSIAN_NOISE , UNI : UNIFORM_NOISE, NN : Without Nowise
Smoothing = 'BS1_BW1'
